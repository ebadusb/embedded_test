...
set buildScript=create_rmsg.bat
set residue=k:\BCT_Development\reserved_messages_perforce_builds\residue_rmsg
set buildDirectory=k:\BCT_Development\reserved_messages_perforce_builds
set perforce_tools=.
...
echo ---------------------------------------------------------------
echo ----------                                      ---------------
echo ---------   Reserved Messages Autobuild Script    -------------
echo ----------                                      ---------------
echo ---------------------------------------------------------------
echo ===============================================================
...
set current_build_label=reserved_messages_build_%build%
...
call %perforce_tools%\batch_substitute.bat BBB %build% %perforce_tools%\rmsg_wsp_template.tmp > %workspace_1%
...
call %perforce_tools%\batch_substitute.bat LLLL %current_build_label% %perforce_tools%\rmsg_label_template.tmp > %residue%\label_1.tmp
call %perforce_tools%\batch_substitute.bat UUUU %user_name% %residue%\label_1.tmp > %residue%\label_2.tmp
call %perforce_tools%\batch_substitute.bat BBB %build% %residue%\label_2.tmp > %residue%/rmsg_label.tmp

P4  label -i < %residue%/rmsg_label.tmp
...
echo Building reserved messages project 
echo Building reserved messages project >> %sandboxDirectory%\create.log 
...
set /p exitCode=
echo end of reserved messages build 
