...
set residue=k:\BCT_Development\optia_perforce\residue_languages
...
call %perforce_tools%\batch_substitute.bat BBB %build% %perforce_tools%\languages_wsp_template.tmp > %workspace_1%
...
call %perforce_tools%\batch_substitute.bat BBB %build% %residue%\label_2.tmp > %residue%/languages_label.tmp

P4  label -i < %residue%/languages_label.tmp
...
set /p exitCode=
echo end of TAOS Languages build 
